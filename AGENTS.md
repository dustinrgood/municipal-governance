...
- `setup-project` — Scaffolds a Cowork Project workspace folder with the right directory structure, starter watcher memory files, and a project-level AGENTS.md, enabling persistent memory across sessions
